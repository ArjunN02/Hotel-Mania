...
const AllRooms = () => {
  ...
  useEffect(() => {
    const getPost = async () => {
      ...
      try {
          axios.post(`${process.env.REACT_APP_API_URL}/api/room/getRoomsByHotel`,filterData).then((response) => {
                ...
                <Card style={{ textAlign: "center" }}>
                  ...
                  <div className="car-footer align-center">
                    <div>
                      <h3>{title}</h3>
                      <h4>
                        Rs.{price}/<span className="shift">night</span>
                      </h4>
                    </div>
                    <div>
